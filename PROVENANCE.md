...
| `test/enzyme_drive_gradient.f90`, `test/enzyme_phase_assembly_gradient.f90`, `test/enzyme_physical_mass_gradient.f90`, `test/enzyme_physical_mass_assembly_gradient.f90`, `cmake/EnzymeFortran.cmake` | Enzyme reverse-mode gradients of the local energy, phase assembly, and physical mass kernel and element assembly | Moses and Churavy, Enzyme (NeurIPS 2020) |
